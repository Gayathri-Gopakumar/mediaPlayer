  ...
  return (
    <div style={{height:'300px'}} className='container w-100 mt-5 '>
     <div className='d-flex justify-content-between'>
       ...
       <div className="links">
       <h5>Links</h5>
       <Link to={'/'} style={{textDecoration:'none',display:'block',color:'white'}}>Landing Page</Link>
       <Link to={'/home'} style={{textDecoration:'none',display:'block',color:'white'}}>Home Page</Link>
       <Link to={'/history'} style={{textDecoration:'none',display:'block',color:'white'}}>Watch History</Link>
     ...
     <p className='text-center mt-5'>Copyrigth © August 2024 Project. Media Player. Built with React.</p>
    </div>
  )
}
